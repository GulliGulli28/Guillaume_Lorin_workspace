 ...
 *
 */
public abstract class Gemstone<T1 extends Valuable> implements Valuable{
	...
	*/
	 ...
	 */
		private GenericSafe<T1> myGenericSafe = null;
	 ...
	 */
	public void setMySafe(GenericSafe<T1> myGenericSafe) {
